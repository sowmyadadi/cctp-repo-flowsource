...
public class SeleniumParametersBuilders {
	 ...
	 */
	public SeleniumParametersBuilders(String currentScenario, String currentTestcase, String packageName) { // added changes for leap
		this.testParameters = new SeleniumTestParameters(currentScenario, currentTestcase, packageName); // added changes for leap
	}
