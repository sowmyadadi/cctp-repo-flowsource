...
public class SeleniumTestParameters extends TestParameters {
	...
	public SeleniumTestParameters(String currentScenario, String currentTestcase, String packageName) { // added changes for leap
		super(currentScenario, currentTestcase, packageName); // added changes for leap
	 ...
	 * List within the GlobalSettings.properties file
	 * 
	 * @param deviceName
