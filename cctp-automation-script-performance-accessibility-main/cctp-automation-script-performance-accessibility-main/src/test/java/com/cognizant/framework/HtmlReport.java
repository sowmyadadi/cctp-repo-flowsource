...
class HtmlReport implements ReportType {
    ...
    @Override
    public void updateTestLog(String stepNumber, String stepName, String stepDescription, Exception stackTrace, String errorMessage, Status stepStatus, String screenshotName) {
        updateTestLog(stepNumber, stepName, stepDescription, stepStatus, screenshotName);
    }
