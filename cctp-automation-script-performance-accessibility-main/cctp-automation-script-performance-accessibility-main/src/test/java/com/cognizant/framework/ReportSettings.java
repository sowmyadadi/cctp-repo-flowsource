...
public class ReportSettings {
     ...
     * be generated
     *
     * @param generateExcelReports Boolean value indicating whether Excel reports should be
     *                             generated
     */
     ...
     * generated
     *
     * @param generateHtmlReports Boolean value indicating whether HTML reports should be
     *                            generated
     */
     ...
     * be generated
     *
     * @param generateSeeTestReports Boolean value indicating whether SeeTest reports should be
     *                               generated
     */
     ...
     * should be generated
     *
     * @param generatePerfectoReports Boolean value indicating whether Perfecto reports should be
     *                                generated
     */
     ...
     * captured for failed steps
     *
     * @param takeScreenshotFailedStep Boolean value indicating whether a screenshot should be
     *                                 captured for failed steps
     */
     ...
     * captured for passed steps
     *
     * @param takeScreenshotPassedStep Boolean value indicating whether a screenshot should be
     *                                 captured for passed steps
     */
     ...
     * must be linked to the corresponding step within the test log
     *
     * @param linkScreenshotsToTestLog Boolean value indicating whether any screenshot taken must be
     *                                 linked to the corresponding step within the test log
     */
     ...
     * logs must be linked to the result summary
     *
     * @param linkTestLogsToSummary Boolean value indicating whether the individual test logs must
     ...
     * must be consolidated into a Word document
     *
     * @param consolidateScreenshotsInWordDoc Boolean value indicating whether all the screenshots must be
     *                                        consolidated into a Word document
     */
