...
public class TestConfigurationsLite extends CRAFTLiteTestCase {
	...
	public Object[][] desktopBrowsers(Method currentMethod) {
		...
		return new Object[][] { { new SeleniumParametersBuilders(currentScenario, currentTestcase, packageName) // added changes for leap
	...
	public Object[][] api(Method currentMethod) {
		...
		return new Object[][] {
				{ new SeleniumParametersBuilders(currentScenario, currentTestcase, packageName).testInstance("Instance1") // added changes for leap
