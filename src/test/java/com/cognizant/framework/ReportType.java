...
interface ReportType {
    ...
    // Changed for LEAP
    public void updateTestLog(String stepNumber, String stepName, String stepDescription,
                              Exception stackTrace, String errorMessage, Status stepStatus,
                              String screenshotName);
     ...
     *
     * @param testParameters The {@link TestParameters} object containing the details of
     *                       the test instance which was executed
     * @param testReportName The name of the test report file corresponding to the test
     *                       instance
