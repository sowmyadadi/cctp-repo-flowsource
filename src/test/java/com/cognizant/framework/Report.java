...
public class Report {
	...
	public void updateTestLog(String stepName, String stepDescription, Status stepStatus,CraftDriver driver) {
	...
	/**
	 * CHANGED FOR LEAP Function to update the test log with the details of a
	 ...
	 * @param stepStatus      The status of the test step
	 */
	public void updateTestLog(String stepName, String stepDescription, Exception stackTrace, String errorMessage,
			Status stepStatus) {
		...
		if (stepStatus.ordinal() <= reportSettings.getLogLevel()) {
			...
			if (!stepName.contains("DriverScript")) {
				screenshotName = handleStepInvolvingScreenshot(stepName, stepStatus);
			}

			for (int i = 0; i < reportTypes.size(); i++) {
				reportTypes.get(i).updateTestLog(Integer.toString(stepNumber), stepName, errorMessage, stackTrace,
						errorMessage, stepStatus, screenshotName);
...
//
//		//System.out.println("startTransaction in Report");
//		for (int i = 0; i < reportTypes.size(); i++) {
//			reportTypes.get(i).startTransaction(transactionName);
//		}
//	}
//
//	public void endTransaction(String transactionName, JavascriptExecutor js) {
//		//System.out.println("endTransaction in Report");
//		for (int i = 0; i < reportTypes.size(); i++) {
//			reportTypes.get(i).endTransaction(transactionName,js);
//		}
//	}
}